...
/**
 * PostgreSQLQueryInsert。
 * テストクラス。
 *
 *
 */
class PostgreSQLQueryInsertTest extends PostgreSQLBaseTest {
    ...
    public function testInsert() {
        ...
        // INSERTクエリ
        $queryInsert = DBFactory::createInsert(self::$postgresDBName)
                ->from('test')
        ...
        $this->assertSame(12345, $ret[$rowIndex]['column3']);
        $this->assertSame(true, $ret[$rowIndex]['column4']);
    }
    ...
    public function testInsertAllChar() {
        ...
        $this->assertSame(32345, $ret[$rowIndex]['column3']);
